...
const Booking = () => {
  ...
  // Redirect after the confirmation message is displayed
  useEffect(() => {
    if (confirmationMessage.includes("success")) {
        ...
        <>
          ...
          {confirmationMessage && (
            <Typography
              ...
              align="center"
              color={
                confirmationMessage.includes("failed") ? "error" : "success"
              }
            >
              {confirmationMessage}
            </Typography>
            ...
            >
              ...
              <Box display={"flex"} flexWrap={"wrap"} margin={1}>
                ...
                {movie.actors.map((item) => (
                  <Typography key={item} fontStyle={"italic"}>
                    {item} &nbsp;
                  </Typography>
                ))}
              </Box>
          ...
          <Dialog open={true} PaperProps={{ style: { borderRadius: 10 } }}>
            <Box margin={4}>
              ...
              <Typography variant="h6" padding={1}>
                You need to log in to proceed further.
              </Typography>
